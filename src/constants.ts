export const ENV_PARAMS = [
  ...
  'SYNC_INTERVAL',
  'BACKUP_INTERVAL',
  'WEBDAV_EXCLUDE_CACHE',
  'WEBDAV_EXCLUDE_MUSIC',
  'USER_ENABLE_PATH',
  'USER_ENABLE_ROOT',
  ...
  'SUBSONIC_QUALITY_ENABLED',
  'SUBSONIC_QUALITY_PRIORITY',
  'SUBSONIC_QUALITY_CLIENT_CAP_MODE',
  'SUBSONIC_SOURCE_PRIORITY',
  'SUBSONIC_SOURCE_CROSS_PLATFORM',
  'SUBSONIC_SOURCE_AUTOSWITCH_CUSTOM',
